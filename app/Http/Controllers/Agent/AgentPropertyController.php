...
class AgentPropertyController extends Controller
{
    ...
    public function AgentEditProperty($id)
    {
        ...
        return view ('agent.property.edit_property', compact('property', 'propertyType','amenities', 'property_ami', 'multiImage', 'facility'));
    ...
    public function StoreBusinessPlan(Request $request)
    {
        ...
        PackagePlan::insert([
            ...
            'package_credits'    => '3',
            'invoice'           => 'RE'.mt_rand(10000000,99999999),
            'package_amount'      => '20',
            'created_at'        => Carbon::now(),
    ...
    /**
     *  This function allows or return views 
    ...
    public function AgentMessageDetails($id)
    {
        ...
        $usermsg = PropertyMessage::where('agent_id',$user_id)->get();
