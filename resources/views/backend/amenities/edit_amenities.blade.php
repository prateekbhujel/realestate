                    ...
                    <h6 class="card-title">
                       Edit Amenities
                        ...
                        <form id="myForm" class="forms-sample" method="POST" action="{{ route('update.amenities') }}">
                            @csrf
                            <input type="hidden" name="id" id="id" value="{{ $amenities->id}}">
                            <div class="row">

                                <div class="form-group mb-3 mt-4">
                                    <label for="amenities_name" class="form-label">Amenities Name</label><span class="text-danger"> *</span>
                                    <input type="text" class="form-control @error('amenities_name') is-invalid @enderror" name="amenities_name" id="amenities_name" value="{{ $amenities->amenities_name }}" placeholder="Type Name for the Amenities">
