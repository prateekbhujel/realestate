...
<link href="{{ asset('backend/assets/css/bootstrap-toogle-min.css')}}" rel="stylesheet">
...
<div class="page-content">
	  ...
	  <a href="{{ route('add.agent') }}" class="btn btn-inverse-info"> Add Agent    </a>
       ...
       <a href="{{ route('edit.agent',$item->id) }}" class="btn btn-inverse-warning btn-xs" title="Edit"> <i data-feather="edit"></i> </a>

       <a href="{{ route('delete.agent',$item->id) }}" class="btn btn-inverse-danger btn-xs" id="delete" title="Delete"> <i data-feather="trash-2"></i>  </a>
                        </td> 
                      </tr>
                     @endforeach
                    </tbody>
