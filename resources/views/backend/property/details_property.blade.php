        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr> 
                    <td>Main Image</td>
                    <td>
                        <img src="{{ asset($property->property_thumbnail) }}"  style="object-fit:fill; height:100px; width:100px;">
                    </td> 
                </tr>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                    ...
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr> 
                                ...
                                <td>
                                    <select name="amenities_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%" readonly>
             ...
             <form method="post" action="{{ route('inactive.property') }}" >
              ...
              <button type="submit" class="btn btn-danger">Make Property Inactive </button>
             ...
             <input type="hidden" name="id" value="{{ $property->id }}">
              ...
              <button type="submit" class="btn btn-success">Make Property Active </button>
