...
@section('main')
  ...
  <figure class="author-thumb"><img src="{{ url('upload/main.jpg') }}" alt=""></figure>
                      <h6>Admin</h6>
                  @else
            ...
            @endforeach
                            ...
                            <div class="location-box content-widget">
                                ...
                                <div class="google-map-area">
                                    ...
                                    frameborder="0"
                                    style="border:0"
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d0.000000!2d{{ $property->longitude }}!3d{{ $property->latitude }}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb9b6b972defa55ff!2sBiratnagar%20Airport!5e0!3m2!1sen!2s!4v1630740191234"
                                    allowfullscreen
                                ></iframe>
                                ...
                                <div class="author-box">
                                    ...
                                    @if ($property->agent_id == Null)
                                        ...
                                        <div class="inner">
                                            <h4>Admin</h4>
                                            <ul class="info clearfix">
                                                <li><i class="fas fa-map-marker-alt"></i>Biratnagar, Jamungachhi, Nepal</li>
                                                <li><i class="fas fa-phone"></i><a href="tel:+977-9862500130">9862500130</a></li>
                                            </ul>
