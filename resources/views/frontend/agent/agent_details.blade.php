...
<h4>{{ $agent->name }}</h4>
<span class="designation">Username: {{ $agent->username }}</span>
</div>
                ...
                <div class="lower-content">
                        ...
                        @if($item->agent_id == Null)
                            <div class="author-box pull-right">
                                <figure class="author-thumb"> 
                                    <img src="{{ url('upload/main.jpg') }}" alt="">
                                    <span> Admin </span>
                                </figure>
                            </div>
                        @else
                    ...
                    <div class="other-info-box clearfix">
                        ...
                        <ul class="other-option pull-right clearfix">
                            ...
                            <li><a aria-label ="Compare Products" class="action-btn" id="{{ $item->id }}" onclick="addToCompare(this.id)"><i class="icon-12"></i></a></li>
